{
  ...
  hash =
    {
      x86_64-linux = "sha256-COb8nihk8HQFy0g7JRit3qVDVhjQuvjqYesJ8CFOodM=";
      aarch64-linux = "sha256-cgjtpJZ8M37tuN1Dw60U48JLAJs9ZhGVL2CWTlR0HHg=";
      x86_64-darwin = "sha256-MoY9yazSt4X0k6E9nQeJa53pYM6j/ctdqQs94s+TXQA=";
      aarch64-darwin = "sha256-fbrNK0q8ojYl9RLk83mkCI3uB6hXQvZk+G23qX+ItjI=";
    }
    .${system}
    or throwSystem;
